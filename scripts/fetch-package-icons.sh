...
curl -fsSL -o "${DEST}/bazarr.png" "https://www.bazarr.media/assets/img/logo.png"
...
curl -fsSL -o "${DEST}/organizr.png" "https://raw.githubusercontent.com/walkxcode/dashboard-icons/main/png/organizr.png"
